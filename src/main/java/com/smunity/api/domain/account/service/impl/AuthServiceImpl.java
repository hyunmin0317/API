...
public class AuthServiceImpl implements AuthService {
    @Override
    public Map<String, String> signIn(AuthDto.Request request) throws IOException {
    ...
    @Override
    public AuthDto.Response getInformation(Map<String, String> cookies) throws IOException {
        if (cookies == null)
