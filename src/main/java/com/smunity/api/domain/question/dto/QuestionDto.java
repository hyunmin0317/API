...
public class QuestionDto {
    ...
    public static class Response {
        ...
        public static QuestionDto.Response of(Question question) {
        ...
        public static List<QuestionDto.Response> of(List<Question> questionList) {
            return questionList.stream().map(QuestionDto.Response::of).collect(Collectors.toList());
        }
    }
